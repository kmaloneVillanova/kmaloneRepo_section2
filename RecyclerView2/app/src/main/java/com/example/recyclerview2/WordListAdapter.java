...
public class WordListAdapter extends
    ...
    //make sure it includes your data source
    ...
    @NonNull
    @Override
    //This method instantiates the layout for the items in the RecyclerView
    //It also creates a new ViewHolder for the items
    ...
    @Override
    //This method sets our data source to the views in the item layout
    ...
    class WordViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        //instantiate all views in the item layout resource
        ...
        public void onClick(View v) {
            ...
            */
            //Use Intent to start a new activity when an item is clicked
